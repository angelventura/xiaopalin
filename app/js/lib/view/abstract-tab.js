...
console.log("Loading file:abstract-tab.js ...");/*global document:false, sessionStorage: false, console: false, alert: false, $: false, window: false, jQuery:false,  location:false, debugger:false, navigator:false, localStorage:false,google: false */
...
const SINGLETON=class AbstractTab extends AbstractView {
    ...
    renderView(){
		...
		if (this.$el.length > 0) {
            Log.info("abstract-tab: Rendering into element:"+name);
