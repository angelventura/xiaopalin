...
console.log("Loading file:abstract-url-input-widget.js ...");/*global document:false, sessionStorage: false, console: false, alert: false, $: false, window: false, jQuery:false,  location:false, debugger:false, navigator:false, localStorage:false,google: false */
...
const SINGLETON=class InputUrl extends Parent {
    ...
    constructor(paramName,defaultValue,selector){
        super("abstract-url-input-widget",paramName,defaultValue);
